...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="/dashboard"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-chartjs')) }}">الفواتير الغير مدفوعة
                        </a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">تقارير الفواتير</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-flot')) }}">تقارير العملاء</a></li>
                </ul>
            </li>
            {{-- المستخدمين --}}
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">قائمة المستخدمين</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-flot')) }}">صلاحية المستخدمين</a>
                    </li>
                </ul>
            </li>
            {{-- الاعدادات  --}}
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="/sections">إضافة قسم</a>
                    </li>
                    <li><a class="slide-item" href="/products">إضافة منتج</a>
                    </li>
                </ul>
            </li>
        </ul>
